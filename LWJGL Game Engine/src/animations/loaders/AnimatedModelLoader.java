...
public class AnimatedModelLoader {
	 ...
	 */
	public static AnimatedModel loadEntity(String modelName, String textureName) {

		AnimatedModelData entityData = ColladaLoader.loadColladaModel("/res/" + modelName + ".dae", Constants.MAX_WEIGHTS);
		Vao model = createVao(entityData.getMeshData());
		GenericTexture texture = loadTexture("/res/" + textureName + ".png");
	 ...
	 */
	private static GenericTexture loadTexture(String textureFile) {

		GenericTexture diffuseTexture = GenericTexture.newTexture(textureFile).anisotropic().create();
