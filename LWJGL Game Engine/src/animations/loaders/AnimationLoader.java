...
import animations.animation.JointTransform;
import animations.animation.KeyFrame;
import animations.animation.Quaternion;
import animations.colladaparser.colladaloader.ColladaLoader;
import animations.colladaparser.datastructures.AnimationData;
import animations.colladaparser.datastructures.JointTransformData;
import animations.colladaparser.datastructures.KeyFrameData;
...
public class AnimationLoader {
	...
	public static Animation loadAnimation(String colladaFile) {
		...
		AnimationData animationData = ColladaLoader.loadColladaAnimation("/res/" + colladaFile + ".dae");
