...
public class AnimatedModel {
	...
	private final GenericTexture texture;
	 ...
	 * 
	 */
	public AnimatedModel(Vao model, GenericTexture texture, Joint rootJoint, int jointCount) {
	 ...
	 */
	public GenericTexture getTexture() {
